...
function sum() {
  total = operate(
    parseFloat(displayValueOne),
    operatorValue,
    parseFloat(displayValueTwo)
  );
  displayValueTotal = total;
  displayValueOne = total;

  if (
    displayScreen.innerHTML === "Infinity" ||
    displayScreen.innerHTML === "NaN"
  ) {
...
const darkHeading = document.querySelector(".dark");
